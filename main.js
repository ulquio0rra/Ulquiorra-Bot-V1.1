...
auth: state,
browser: ['dynamicBot','Safari','9.7.0'],
version   
}
...
conn.welcome = '✦━━━━━━[ 𝔘𝔩𝔮𝔲𝔦𝔬𝔯𝔯𝔞 ]━━━━━━✦\n\n┏––––––━━━━━━━━•\n│⫹⫺ @subject\n┣━━━━━━━━┅┅┅\n│( 👋🏻مــنــور الاســطــوري@user)\n├[ *المطور* ]—\n│*𝔘𝔩𝔮𝔲𝔦𝔬𝔯𝔯𝔞*\n┗––––––━━┅┅┅\n\n––––––┅┅ *اقــرأ الــوصــف* ┅┅––––––\n@desc' 
   conn.bye = '✦━━━━━━[ 𝔘𝔩𝔮𝔲𝔦𝔬𝔯𝔯𝔞 ]━━━━━━✦\n *كــــلـــب يــطــلــع, اســـد يــدخــل*@user* 👋🏻  ( ╹▽╹ )'
conn.spromote = '*@user مـبـروك الادمـن ✨💜*'
conn.sdemote = '*@user كـنـت ادمـن حـلـو  😭💜*'
conn.sDesc = '*تـــم تــعــديــل وصــف الــجــروب*\n\n*الـوصـف الـجـديـد:* @desc'
conn.sSubject = ' تــم تــغــيــر اســـم الـــجـــروب ✨💜*\n*الاســم الــجــديــد:* @subject'
conn.sIcon = '*تــم تـغـيـر صـوره الـجـروب ✨💜*'
conn.sRevoke = '*تـم تـحـديـث رابـط الـجـروب ✨💜*\n*الـلـيـنـك الـجـديـد:* @revoke'
...
_quickTest()
.then(() => conn.logger.info(`انتظر لحظه．．．\n`))
.catch(console.error)
